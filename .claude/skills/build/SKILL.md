---
name: build
description: Build and test reference for the ToyC compiler. Use when answering questions about make targets, running tests, CI/CD workflows, or compiler CLI flags.
